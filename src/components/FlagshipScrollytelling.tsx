          ...
          <div className="lg:col-span-5 relative flex items-center min-h-[380px] sm:min-h-[420px]">
            <AnimatePresence mode="wait">
              ...
              >
                {/* Heading */}
                <div>
                  <h4 className="text-3xl sm:text-4xl md:text-5xl lg:text-[52px] font-black text-transparent bg-clip-text bg-gradient-to-r from-[#0E7490] via-[#06B6D4] to-[#0E7490] tracking-tight leading-[1.05]">
