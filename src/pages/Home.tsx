...
const Home = () => {
  return (
    <div className="w-full">
      ...
      {/* ============================================================
          HERO SECTION — Calm Flagship Aesthetic (#F5F9FA + Dot Pattern)
      ============================================================ */}
      <section className="relative min-h-[88vh] flex items-center pt-28 pb-16 overflow-hidden bg-[#F5F9FA]">
        
        {/* Subtle Architectural Dot Matrix Background Pattern */}
        <div 
          className="absolute inset-0 bg-[radial-gradient(#0E7490_1.2px,transparent_1.2px)] [background-size:28px_28px] opacity-[0.07] pointer-events-none" 
        />

        {/* Soft Ambient Light Gradient Mask */}
        <div className="absolute top-1/4 left-1/3 -translate-x-1/2 w-[800px] h-[500px] bg-[radial-gradient(ellipse_at_center,rgba(6,182,212,0.12)_0%,transparent_65%)] pointer-events-none" />
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/90 border border-slate-200/90 shadow-xs text-xs font-semibold text-[#0C1A20] mb-6 backdrop-blur-md">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-3.5 py-1.5 bg-white border border-slate-200/90 rounded-full text-xs font-bold text-[#0C1A20] flex items-center gap-2 shadow-2xs">
